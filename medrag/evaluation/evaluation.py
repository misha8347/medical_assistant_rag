...
corpus_path = f"./datasets/{args.task}/corpus.jsonl"
query_path = f"./datasets/queries/{args.split}_queries.jsonl"
qrels_path = f"./datasets/{args.task}/qrels_{args.split}.tsv"
